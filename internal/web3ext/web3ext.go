...
web3._extend({
	...
	[
		...
		new web3._extend.Method({
			...
			call: 'bzc_signTransaction',
			params: 1,
			inputFormatter: [web3._extend.formatters.inputTransactionFormatter]
		}),
		new web3._extend.Method({
			name: 'submitTransaction',
			call: 'bzc_submitTransaction',
			params: 1,
			inputFormatter: [web3._extend.formatters.inputTransactionFormatter]
		}),
		new web3._extend.Method({
			name: 'getRawTransaction',
			call: 'bzc_getRawTransactionByHash',
			params: 1
		}),
		new web3._extend.Method({
			name: 'getRawTransactionFromBlock',
			call: function(args) {
				return (web3._extend.utils.isString(args[0]) && args[0].indexOf('0x') === 0) ? 'bzc_getRawTransactionByBlockHashAndIndex' : 'bzc_getRawTransactionByBlockNumberAndIndex';
			},
			params: 2,
	...
	[
		new web3._extend.Property({
			...
			getter: 'bzc_pendingTransactions',
...
web3._extend({
	...
	[
		...
		new web3._extend.Method({
			name: 'setBazacoinbase',
			call: 'miner_setBazacoinbase',
			params: 1,
