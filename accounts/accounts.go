...
// Package accounts implements high level Bazacoin account management.
package accounts
...
// Account represents an Bazacoin account located at a specific location defined
// by the optional URL field.
type Account struct {
	Address common.Address `json:"address"` // Bazacoin account address derived from the key
...
type Wallet interface {
	...
	// chain state reader.
	SelfDerive(base DerivationPath, chain bazacoin.ChainStateReader)
