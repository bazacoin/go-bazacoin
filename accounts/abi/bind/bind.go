...
// Package bind generates Bazacoin contract Go bindings.
//
// Detailed usage document and tutorial available on the go-bazacoin Wiki page:
// https://github.com/bazacoin/go-bazacoin/wiki/Native-DApps:-Go-bindings-to-Bazacoin-contracts
package bind
