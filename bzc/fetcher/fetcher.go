...
type Fetcher struct {
	...
	fetchingHook       func([]common.Hash)     // Method to call upon starting a block (bzc/61) or header (bzc/62) fetch
	completingHook     func([]common.Hash)     // Method to call upon starting a block body fetch (bzc/62)
	importedHook       func(*types.Block)      // Method to call upon successful block import (both bzc/61 and bzc/62)
}
