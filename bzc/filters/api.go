...
// information related to the Bazacoin protocol such als blocks, transactions and logs.
...
// `bzc_getFilterChanges` polling method that is also used for log filters.
//
// https://github.com/bazacoin/wiki/wiki/JSON-RPC#bzc_newpendingtransactionfilter
...
// It is part of the filter package since polling goes with bzc_getFilterChanges.
//
// https://github.com/bazacoin/wiki/wiki/JSON-RPC#bzc_newblockfilter
...
//
// https://github.com/bazacoin/wiki/wiki/JSON-RPC#bzc_newfilter
...
//
// https://github.com/bazacoin/wiki/wiki/JSON-RPC#bzc_getlogs
...
//
// https://github.com/bazacoin/wiki/wiki/JSON-RPC#bzc_uninstallfilter
...
//
// https://github.com/bazacoin/wiki/wiki/JSON-RPC#bzc_getfilterlogs
...
//
// https://github.com/bazacoin/wiki/wiki/JSON-RPC#bzc_getfilterchanges
