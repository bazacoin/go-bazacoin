...
func testGetNodeData(t *testing.T, protocol int) {
	...
	hashes := []common.Hash{}
	for _, key := range pm.chaindb.(*bzcdb.MemDatabase).Keys() {
	...
	statedb, _ := bzcdb.NewMemDatabase()
...
// Tests that post bzc protocol handshake, DAO fork-enabled clients also execute
