...
var ProtocolName = "bzc"

// Supported versions of the bzc protocol (first is primary).
...
// bzc protocol message codes
const (
	// Protocol messages belonging to bzc/62
	StatusMsg          = 0x00
	...
	// Protocol messages belonging to bzc/63
	GetNodeDataMsg = 0x0d
	NodeDataMsg    = 0x0e
	GetReceiptsMsg = 0x0f
	ReceiptsMsg    = 0x10
