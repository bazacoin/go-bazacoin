...
type downloadTester struct {
	...
	stateDb bzcdb.Database // Database used by the tester for syncing from peers
	peerDb  bzcdb.Database // Database of the peers containing all data
...
func newTester() *downloadTester {
	...
	tester.stateDb, _ = bzcdb.NewMemDatabase()
