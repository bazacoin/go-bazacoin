...
// Syncing provides information when this nodes starts synchronising with the Bazacoin network and when it's finished.
...
type SyncingResult struct {
	...
	Status  bazacoin.SyncProgress `json:"status"`
}
