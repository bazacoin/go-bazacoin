...
import (
	...
	"github.com/bazacoin/go-bazacoin/cmd/internal/browser"
...
const issueUrl = "https://github.com/bazacoin/go-bazacoin/issues/new"

// reportBug reports a bug by opening a new URL to the go-bazacoin GH issue
