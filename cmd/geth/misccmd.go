...
var (
	makedagCommand = cli.Command{
		...
		Name:      "makedag",
		Usage:     "Generate bzhash DAG (for testing)",
		ArgsUsage: "<blockNum> <outputDir>",
		Category:  "MISCELLANEOUS COMMANDS",
		Description: `
The makedag command generates an bzhash DAG in /tmp/dag.
...
func makedag(ctx *cli.Context) error {
	...
	case len(args) == 2:
		...
		if err != nil {
			...
			bzhash.MakeDataset(blockNum, dir)
		}
	default:
		wrongArgs()
	}
...
func version(ctx *cli.Context) error {
	...
	fmt.Println("Protocol Versions:", bzc.ProtocolVersions)
	fmt.Println("Network Id:", bzc.DefaultConfig.NetworkId)
