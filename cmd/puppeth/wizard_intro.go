...
// setting up a new or managing an existing Bazacoin private network.
func (w *wizard) run() {
	fmt.Println("+-----------------------------------------------------------+")
	fmt.Println("| Welcome to puppeth, your Bazacoin private network manager |")
	fmt.Println("|                                                           |")
	fmt.Println("| This tool lets you create a new Bazacoin network down to  |")
	fmt.Println("| the genesis block, bootnodes, miners and bzcstats servers |")
	...
	log.Info("Administering Bazacoin network", "name", w.network)
