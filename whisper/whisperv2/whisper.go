...
import (
	...
	"github.com/bazacoin/go-bazacoin/crypto/ecies"
	"github.com/bazacoin/go-bazacoin/event/filter"
...
// Whisper represents a dark communication interface through the Bazacoin
...
// New creates a Whisper client ready to communicate through the Bazacoin P2P
// network.
func New() *Whisper {
	whisper := &Whisper{
		filters:     filter.New(),
