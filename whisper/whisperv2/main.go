...
import (
	...
	"github.com/bazacoin/go-bazacoin/logger"
	"github.com/bazacoin/go-bazacoin/p2p"
	"github.com/bazacoin/go-bazacoin/p2p/nat"
	"github.com/bazacoin/go-bazacoin/whisper"
)
...
func main() {
	...
	// Create an Bazacoin peer to communicate through
	server := p2p.Server{
		PrivateKey: key,
		MaxPeers:   10,
		Name:       name,
	...
	fmt.Println("Starting Bazacoin peer...")
	if err := server.Start(); err != nil {
		fmt.Printf("Failed to start Bazacoin peer: %v.\n", err)
		os.Exit(1)
	}
