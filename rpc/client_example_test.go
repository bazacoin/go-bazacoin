...
//
// bzc_getBlockByNumber("latest", {})
//    returns the latest block object.
//
// bzc_subscribe("newBlocks")
...
func subscribeBlocks(client *rpc.Client, subch chan Block) {
	...
	sub, err := client.BzcSubscribe(ctx, subch, "newBlocks")
	if err != nil {
	...
	var lastBlock Block
	if err := client.CallContext(ctx, &lastBlock, "bzc_getBlockByNumber", "latest"); err != nil {
