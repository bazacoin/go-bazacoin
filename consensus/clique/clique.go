...
import (
	...
	"github.com/bazacoin/go-bazacoin/crypto/sha3"
...
// ecrecover extracts the Bazacoin account address from a signed header.
func ecrecover(header *types.Header, sigcache *lru.ARCCache) (common.Address, error) {
	...
	// Recover the public key and the Bazacoin address
...
// Bazacoin testnet following the Ropsten attacks.
type Clique struct {
	config *params.CliqueConfig // Consensus engine configuration parameters
	db     bzcdb.Database       // Database to store and retrieve snapshot checkpoints
	...
	signer common.Address // Bazacoin address of the signing key
...
func New(config *params.CliqueConfig, db bzcdb.Database) *Clique {
...
// Author implements consensus.Engine, returning the Bazacoin address recovered
