...
func loadSnapshot(config *params.CliqueConfig, sigcache *lru.ARCCache, db bzcdb.Database, hash common.Hash) (*Snapshot, error) {
...
func (s *Snapshot) store(db bzcdb.Database) error {
