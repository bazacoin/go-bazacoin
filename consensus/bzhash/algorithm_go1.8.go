...
// cacheSize calculates and returns the size of the bzhash verification cache that
...
// datasetSize calculates and returns the size of the bzhash mining dataset that
