...
import (
	...
	"github.com/bazacoin/go-bazacoin/internal/build"
)
...
var (
	...
	debExecutables = []debExecutable{
		{
			Name:        "abigen",
			Description: "Source code generator to convert Bazacoin contract definitions into easy to use, compile-time type-safe Go packages.",
		},
		{
			Name:        "bootnode",
			Description: "Bazacoin bootnode.",
		},
		{
			Name:        "evm",
			Description: "Developer utility version of the EVM (Bazacoin Virtual Machine) that is capable of running bytecode snippets within a configurable environment and execution mode.",
		},
		{
			Name:        "geth",
			Description: "Bazacoin CLI client.",
		},
		{
			Name:        "puppeth",
			Description: "Bazacoin private network manager.",
		},
		{
			Name:        "rlpdump",
		...
		{
			Name:        "swarm",
			Description: "Bazacoin Swarm daemon and tools",
		},
		{
			Name:        "wnode",
			Description: "Bazacoin Whisper diagnostic tool",
		},
	}
...
func doInstall(cmdline []string) {
	...
	if runtime.Version() < "go1.7" && !strings.HasPrefix(runtime.Version(), "devel") {
		...
		log.Println("go-bazacoin requires at least Go version 1.7 and cannot")
...
func doDebianSource(cmdline []string) {
	var (
		...
		upload  = flag.String("upload", "", `Where to upload the source package (usually "ppa:bazacoin/bazacoin")`)
...
type debMetadata struct {
	...
	// go-bazacoin version being built. Note that this
...
func newDebMetadata(distro, author string, env build.Environment, t time.Time) debMetadata {
	if author == "" {
		...
		author = "Bazacoin Builds <fjl@bazacoin.org>"
	}
	return debMetadata{
		Env:         env,
		Author:      author,
...
func doAndroidArchive(cmdline []string) {
	...
	build.MustRun(gomobileTool("bind", "--target", "android", "--javapkg", "org.bazacoin", "-v", "github.com/bazacoin/go-bazacoin/mobile"))
...
func doXCodeFramework(cmdline []string) {
	...
	bind := gomobileTool("bind", "--target", "ios", "--tags", "ios", "-v", "github.com/bazacoin/go-bazacoin/mobile")
