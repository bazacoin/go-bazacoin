...
We want to build go-bazacoin with the most recent version of Go, irrespective of the Go
...
can be edited at https://launchpad.net/%7Ebazacoin/+archive/ubuntu/bazacoin/+edit-dependencies
...
Then go into the source package directory for your running distribution and build the package:
    ...
    $ cd dist/bazacoin-unstable-1.6.0+xenial
    $ dpkg-buildpackage
