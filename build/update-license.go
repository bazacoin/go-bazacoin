...
var (
	...
	authorsFileHeader = "# This is the official list of go-bazacoin authors for copyright purposes.\n\n"
)

// this template generates the license comment.
// its input is an info structure.
var licenseT = template.Must(template.New("").Parse(`
// Copyright {{.Year}} The go-bazacoin Authors
...
func (i info) Whole(startOfSentence bool) string {
	...
	if startOfSentence {
		return "The go-bazacoin library"
	}
	return "the go-bazacoin library"
}
