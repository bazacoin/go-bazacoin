...
var (
	...
	configPrefix = []byte("bazacoin-config-") // config prefix for the db
...
func GetCanonicalHash(db bzcdb.Database, number uint64) common.Hash {
...
func GetBlockNumber(db bzcdb.Database, hash common.Hash) uint64 {
...
func GetHeadHeaderHash(db bzcdb.Database) common.Hash {
...
func GetHeadBlockHash(db bzcdb.Database) common.Hash {
...
func GetHeadFastBlockHash(db bzcdb.Database) common.Hash {
...
func GetHeaderRLP(db bzcdb.Database, hash common.Hash, number uint64) rlp.RawValue {
...
// found.
func GetHeader(db bzcdb.Database, hash common.Hash, number uint64) *types.Header {
...
func GetBodyRLP(db bzcdb.Database, hash common.Hash, number uint64) rlp.RawValue {
...
func GetBody(db bzcdb.Database, hash common.Hash, number uint64) *types.Body {
...
// none found.
func GetTd(db bzcdb.Database, hash common.Hash, number uint64) *big.Int {
...
func GetBlock(db bzcdb.Database, hash common.Hash, number uint64) *types.Block {
...
func GetBlockReceipts(db bzcdb.Database, hash common.Hash, number uint64) types.Receipts {
...
func GetTransaction(db bzcdb.Database, hash common.Hash) (*types.Transaction, common.Hash, uint64, uint64) {
...
func GetReceipt(db bzcdb.Database, hash common.Hash) *types.Receipt {
...
func WriteCanonicalHash(db bzcdb.Database, hash common.Hash, number uint64) error {
...
func WriteHeadHeaderHash(db bzcdb.Database, hash common.Hash) error {
...
func WriteHeadBlockHash(db bzcdb.Database, hash common.Hash) error {
...
func WriteHeadFastBlockHash(db bzcdb.Database, hash common.Hash) error {
...
func WriteHeader(db bzcdb.Database, header *types.Header) error {
...
func WriteBody(db bzcdb.Database, hash common.Hash, number uint64, body *types.Body) error {
...
func WriteBodyRLP(db bzcdb.Database, hash common.Hash, number uint64, rlp rlp.RawValue) error {
...
func WriteTd(db bzcdb.Database, hash common.Hash, number uint64, td *big.Int) error {
...
func WriteBlock(db bzcdb.Database, block *types.Block) error {
...
func WriteBlockReceipts(db bzcdb.Database, hash common.Hash, number uint64, receipts types.Receipts) error {
...
func WriteTransactions(db bzcdb.Database, block *types.Block) error {
	batch := db.NewBatch()
...
func WriteReceipt(db bzcdb.Database, receipt *types.Receipt) error {
...
func WriteReceipts(db bzcdb.Database, receipts types.Receipts) error {
	batch := db.NewBatch()
...
func DeleteCanonicalHash(db bzcdb.Database, number uint64) {
	db.Delete(append(append(headerPrefix, encodeBlockNumber(number)...), numSuffix...))
}

// DeleteHeader removes all block header data associated with a hash.
func DeleteHeader(db bzcdb.Database, hash common.Hash, number uint64) {
	db.Delete(append(blockHashPrefix, hash.Bytes()...))
	db.Delete(append(append(headerPrefix, encodeBlockNumber(number)...), hash.Bytes()...))
}

// DeleteBody removes all block body data associated with a hash.
func DeleteBody(db bzcdb.Database, hash common.Hash, number uint64) {
	db.Delete(append(append(bodyPrefix, encodeBlockNumber(number)...), hash.Bytes()...))
}

// DeleteTd removes all block total difficulty data associated with a hash.
func DeleteTd(db bzcdb.Database, hash common.Hash, number uint64) {
	db.Delete(append(append(append(headerPrefix, encodeBlockNumber(number)...), hash.Bytes()...), tdSuffix...))
}

// DeleteBlock removes all block data associated with a hash.
func DeleteBlock(db bzcdb.Database, hash common.Hash, number uint64) {
...
func DeleteBlockReceipts(db bzcdb.Database, hash common.Hash, number uint64) {
	db.Delete(append(append(blockReceiptsPrefix, encodeBlockNumber(number)...), hash.Bytes()...))
}

// DeleteTransaction removes all transaction data associated with a hash.
func DeleteTransaction(db bzcdb.Database, hash common.Hash) {
...
func DeleteReceipt(db bzcdb.Database, hash common.Hash) {
...
// MIP bloom bin.
func WriteMipmapBloom(db bzcdb.Database, number uint64, receipts types.Receipts) error {
	mipmapBloomMu.Lock()
...
func GetMipmapBloom(db bzcdb.Database, number, level uint64) types.Bloom {
	bloomDat, _ := db.Get(mipmapKey(number, level))
	return types.BytesToBloom(bloomDat)
}

// PreimageTable returns a Database instance with the key prefix for preimage entries.
func PreimageTable(db bzcdb.Database) bzcdb.Database {
	return bzcdb.NewTable(db, preimagePrefix)
}

// WritePreimages writes the provided set of preimages to the database. `number` is the
// current block number, and is used for debug messages only.
func WritePreimages(db bzcdb.Database, number uint64, preimages map[common.Hash][]byte) error {
...
func GetBlockChainVersion(db bzcdb.Database) int {
	var vsn uint
...
func WriteBlockChainVersion(db bzcdb.Database, vsn int) {
	enc, _ := rlp.EncodeToBytes(uint(vsn))
	db.Put([]byte("BlockchainVersion"), enc)
}

// WriteChainConfig writes the chain config settings to the database.
func WriteChainConfig(db bzcdb.Database, hash common.Hash, cfg *params.ChainConfig) error {
...
func GetChainConfig(db bzcdb.Database, hash common.Hash) (*params.ChainConfig, error) {
...
func FindCommonAncestor(db bzcdb.Database, a, b *types.Header) *types.Header {
