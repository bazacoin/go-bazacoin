...
func SetupGenesisBlock(db bzcdb.Database, genesis *Genesis) (*params.ChainConfig, common.Hash, error) {
...
func (g *Genesis) Commit(db bzcdb.Database) (*types.Block, error) {
...
// The block is committed as the canonical head block.
func (g *Genesis) MustCommit(db bzcdb.Database) *types.Block {
...
func GenesisBlockForTesting(db bzcdb.Database, addr common.Address, balance *big.Int) *types.Block {
	g := Genesis{Alloc: GenesisAlloc{addr: {Balance: balance}}}
	return g.MustCommit(db)
}

// DefaultGenesisBlock returns the bazacoin main net genesis block.
