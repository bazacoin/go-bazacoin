...
type Context struct {
	...
	// sufficient bazacoin to transfer the value
	CanTransfer CanTransferFunc
	// Transfer transfers bazacoin from one account to the other
...
// EVM is the Bazacoin Virtual Machine base object and provides
...
type EVM struct {
	...
	// evm.
	vmConfig Config
	// global (to this context) bazacoin virtual machine
