...
func makeTestState() (bzcdb.Database, common.Hash, []*testAccount) {
...
// account array.
func checkStateAccounts(t *testing.T, db bzcdb.Database, root common.Hash, accounts []*testAccount) {
...
func checkStateConsistency(db bzcdb.Database, root common.Hash) error {
