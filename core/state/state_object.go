...
// stateObject represents an Bazacoin account which is being modified.
//
...
type stateObject struct {
	address common.Address // Bazacoin address of this account
	data    Account
	db      *StateDB
...
// Account is the Bazacoin consensus representation of accounts.
