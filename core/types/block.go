...
// Package types contains data types related to Bazacoin consensus.
package types
...
// Header represents a block header in the Bazacoin blockchain.
type Header struct {
...
// Block represents an entire block in the Bazacoin blockchain.
type Block struct {
	header       *Header
	uncles       []*Header
	...
	// These fields are used by package bzc to track
...
// [deprecated by bzc/63]
// StorageBlock defines the RLP encoding of a Block stored in the
// state database. The StorageBlock encoding contains fields that
// would otherwise need to be recomputed.
type StorageBlock Block

// "external" block encoding. used for bzc protocol, etc.
...
// DecodeRLP decodes the Bazacoin
...
// EncodeRLP serializes b into the Bazacoin RLP block format.
