...
import (
	...
	"github.com/bazacoin/go-bazacoin/contracts/chequebook"
	"github.com/bazacoin/go-bazacoin/contracts/ens"
	...
	"github.com/bazacoin/go-bazacoin/swarm/api"
	httpapi "github.com/bazacoin/go-bazacoin/swarm/api/http"
	"github.com/bazacoin/go-bazacoin/swarm/fuse"
	"github.com/bazacoin/go-bazacoin/swarm/network"
	"github.com/bazacoin/go-bazacoin/swarm/storage"
)
...
func NewSwarm(ctx *node.ServiceContext, backend chequebook.Backend, config *api.Config, swapEnabled, syncEnabled bool, cors string) (self *Swarm, err error) {
	...
	if backend == (*bzcclient.Client)(nil) {
		log.Warn("No ENS, please specify non-empty --bzcapi to use domain name resolution")
	} else {
