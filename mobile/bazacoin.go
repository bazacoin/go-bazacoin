...
// Contains all the wrappers from the go-bazacoin root package.
...
// the Bazacoin network.
type SyncProgress struct {
	progress bazacoin.SyncProgress
}
