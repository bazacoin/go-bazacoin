...
// Contains a wrapper for the Bazacoin client.
...
// BazacoinClient provides access to the Bazacoin APIs.
type BazacoinClient struct {
	client *bzcclient.Client
}

// NewBazacoinClient connects a client to the given URL.
func NewBazacoinClient(rawurl string) (client *BazacoinClient, _ error) {
	rawClient, err := bzcclient.Dial(rawurl)
	return &BazacoinClient{rawClient}, err
}

// GetBlockByHash returns the given full block.
func (ec *BazacoinClient) GetBlockByHash(ctx *Context, hash *Hash) (block *Block, _ error) {
...
func (ec *BazacoinClient) GetBlockByNumber(ctx *Context, number int64) (block *Block, _ error) {
	if number < 0 {
...
func (ec *BazacoinClient) GetHeaderByHash(ctx *Context, hash *Hash) (header *Header, _ error) {
...
func (ec *BazacoinClient) GetHeaderByNumber(ctx *Context, number int64) (header *Header, _ error) {
	if number < 0 {
...
func (ec *BazacoinClient) GetTransactionByHash(ctx *Context, hash *Hash) (tx *Transaction, _ error) {
...
func (ec *BazacoinClient) GetTransactionCount(ctx *Context, hash *Hash) (count int, _ error) {
...
func (ec *BazacoinClient) GetTransactionInBlock(ctx *Context, hash *Hash, index int) (tx *Transaction, _ error) {
...
func (ec *BazacoinClient) GetTransactionReceipt(ctx *Context, hash *Hash) (receipt *Receipt, _ error) {
...
func (ec *BazacoinClient) SyncProgress(ctx *Context) (progress *SyncProgress, _ error) {
...
func (ec *BazacoinClient) SubscribeNewHead(ctx *Context, handler NewHeadHandler, buffer int) (sub *Subscription, _ error) {
...
func (ec *BazacoinClient) GetBalanceAt(ctx *Context, account *Address, number int64) (balance *BigInt, _ error) {
	if number < 0 {
...
func (ec *BazacoinClient) GetStorageAt(ctx *Context, account *Address, key *Hash, number int64) (storage []byte, _ error) {
	if number < 0 {
...
func (ec *BazacoinClient) GetCodeAt(ctx *Context, account *Address, number int64) (code []byte, _ error) {
	if number < 0 {
...
func (ec *BazacoinClient) GetNonceAt(ctx *Context, account *Address, number int64) (nonce int64, _ error) {
	if number < 0 {
...
func (ec *BazacoinClient) FilterLogs(ctx *Context, query *FilterQuery) (logs *Logs, _ error) {
...
func (ec *BazacoinClient) SubscribeFilterLogs(ctx *Context, query *FilterQuery, handler FilterLogsHandler, buffer int) (sub *Subscription, _ error) {
	// Subscribe to the event internally
...
func (ec *BazacoinClient) GetPendingBalanceAt(ctx *Context, account *Address) (balance *BigInt, _ error) {
...
func (ec *BazacoinClient) GetPendingStorageAt(ctx *Context, account *Address, key *Hash) (storage []byte, _ error) {
...
func (ec *BazacoinClient) GetPendingCodeAt(ctx *Context, account *Address) (code []byte, _ error) {
...
func (ec *BazacoinClient) GetPendingNonceAt(ctx *Context, account *Address) (nonce int64, _ error) {
...
func (ec *BazacoinClient) GetPendingTransactionCount(ctx *Context) (count int, _ error) {
...
func (ec *BazacoinClient) CallContract(ctx *Context, msg *CallMsg, number int64) (output []byte, _ error) {
	if number < 0 {
...
func (ec *BazacoinClient) PendingCallContract(ctx *Context, msg *CallMsg) (output []byte, _ error) {
	return ec.client.PendingCallContract(ctx.context, msg.msg)
}

// SuggestGasPrice retrieves the currently suggested gas price to allow a timely
// execution of a transaction.
func (ec *BazacoinClient) SuggestGasPrice(ctx *Context) (price *BigInt, _ error) {
...
func (ec *BazacoinClient) EstimateGas(ctx *Context, msg *CallMsg) (gas *BigInt, _ error) {
...
func (ec *BazacoinClient) SendTransaction(ctx *Context, tx *Transaction) error {
