...
// DeployReleaseOracle deploys a new Bazacoin contract, binding an instance of ReleaseOracle to it.
...
// ReleaseOracle is an auto generated Go binding around an Bazacoin contract.
...
// ReleaseOracleCaller is an auto generated read-only Go binding around an Bazacoin contract.
type ReleaseOracleCaller struct {
	contract *bind.BoundContract // Generic contract wrapper for the low level calls
}

// ReleaseOracleTransactor is an auto generated write-only Go binding around an Bazacoin contract.
type ReleaseOracleTransactor struct {
	contract *bind.BoundContract // Generic contract wrapper for the low level calls
}

// ReleaseOracleSession is an auto generated Go binding around an Bazacoin contract,
...
// ReleaseOracleCallerSession is an auto generated read-only Go binding around an Bazacoin contract,
...
// ReleaseOracleTransactorSession is an auto generated write-only Go binding around an Bazacoin contract,
...
// ReleaseOracleRaw is an auto generated low-level Go binding around an Bazacoin contract.
type ReleaseOracleRaw struct {
	Contract *ReleaseOracle // Generic contract binding to access the raw methods on
}

// ReleaseOracleCallerRaw is an auto generated low-level read-only Go binding around an Bazacoin contract.
...
// ReleaseOracleTransactorRaw is an auto generated low-level write-only Go binding around an Bazacoin contract.
