...
// ReleaseOracle is an Bazacoin contract to store the current and previous
// versions of the go-bazacoin implementation. Its goal is to allow Geth to
...
contract ReleaseOracle {
  ...
  // updateSigner marks a vote for changing the status of an Bazacoin user, either
