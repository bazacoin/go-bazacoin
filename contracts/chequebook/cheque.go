...
// Package chequebook package wraps the 'chequebook' Bazacoin smart contract.
//
// The functions in this package allow using chequebook for
// issuing, receiving, verifying cheques in bazacoin; (auto)cashing cheques in bazacoin
// as well as (auto)depositing bazacoin to the chequebook contract.
package chequebook
...
import (
	...
	"github.com/bazacoin/go-bazacoin/contracts/chequebook/contract"
	"github.com/bazacoin/go-bazacoin/core/types"
	"github.com/bazacoin/go-bazacoin/crypto"
	"github.com/bazacoin/go-bazacoin/log"
	"github.com/bazacoin/go-bazacoin/swarm/services/swap/swap"
)
...
// * depositing bazacoin to the chequebook
// * watching incoming bazacoin
...
// Cash cashes the cheque by sending an Bazacoin transaction.
